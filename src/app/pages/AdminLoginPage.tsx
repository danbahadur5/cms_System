      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl text-gray-500">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-amber-800/90">
                  Start the API in a <strong>second terminal</strong> from the
                  project folder:{" "}
                  ...
                  , then click <strong>Check again</strong>. Your{" "}
                  <code className="rounded bg-amber-100/80 px-1">PORT</code> in{" "}
                  <code className="rounded bg-amber-100/80 px-1">.env</code>{" "}
                  must match the Vite proxy (same{" "}
                  <code className="rounded bg-amber-100/80 px-1">PORT</code> is
                  loaded for both).
                </p>
                <p className="mt-2 text-amber-800/90">
                  ...
                  in the <strong>project root</strong>{" "}
                  <code className="rounded bg-amber-100/80 px-1">.env</code> —
                  the server loads that file automatically.
                </p>
                <Button
                  type="button"
                  variant="outline"
                  ...
                  disabled={checking}
                  onClick={() =>
                    void runHealthCheck().then(
                      (ok) => ok && toast.success("API is reachable"),
                    )
                  }
                >
                  <RefreshCw
